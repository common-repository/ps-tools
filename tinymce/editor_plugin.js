...
(function() {
	...
	tinymce.create('tinymce.plugins.post_snippets', {
		...
		init : function(ed, url) {
			...
			ed.addCommand('mcepost_snippets', function() {
				ed.windowManager.open({
					file : url + '/window.php',
					width : 320 + ed.getLang('post_snippets.delta_width', 0),
					height : 400 + ed.getLang('post_snippets.delta_height', 0),
					inline : 1
				}, {
		...
		getInfo : function() {
			return {
					longname  : 'photoshop_tools',
					author 	  : 'Diana K. Cury',
					authorurl : 'http://arquivo.tk/',
					infourl   : 'http://arquivo.tk/dev/ps-tools',
					version   : "1.0"
			};
		}
	});
